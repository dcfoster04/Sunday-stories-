...
export function Confirmation({ leagueName }: { leagueName: string }) {
  return (
    <div className="mx-auto w-full max-w-lg text-center">
      <Reveal>
        <Kicker tone="flare">Filed.</Kicker>
        <h1 className="mt-4 text-balance font-display text-3xl font-black uppercase leading-tight tracking-tighter text-ink-950 sm:text-4xl">
